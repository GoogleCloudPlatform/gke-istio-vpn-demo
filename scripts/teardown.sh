...
gcloud beta container clusters update $ISTIO_CLUSTER --project=$ISTIO_PROJECT --update-addons=Istio=DISABLED
#kubectl delete -f "$ISTIO_DIR/install/kubernetes/istio-demo.yaml" --ignore-not-found=true #this one
